...
COLORS = {
    ...
    "CTC_Residual_condition": "#2ca02c", # 绿色 
...
if __name__ == "__main__":
    ...
    # 依然是4个进程，多出的第5个任务会自动补位空闲出来的GPU 0
    ...
    plt.savefig("Adaptive_Control_Tracking_All.png", dpi=300)
    ...
    plt.tight_layout()
    plt.savefig("Adaptive_Control_Effort_All.png", dpi=300)
    
    print("✅ 自适应控制实验图表已保存为 Adaptive_Control_Tracking_All.png 和 Adaptive_Control_Effort_All.png")